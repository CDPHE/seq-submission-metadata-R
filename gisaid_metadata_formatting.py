...
#     gisaid_df['covv_coverage'] = ''
    ...
    gisaid_df['covv_authors'] = 'Laura Bankers, Molly C. Hetherington-Rauth, Diana Ir, Alexandria Rossheim, Michael Martin, Mandy Waters, Arianna Smith, Haikel N. Bogale, Shannon R. Matzinger, Emily A. Travanty'
