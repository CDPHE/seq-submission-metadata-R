...
#     print(metadata_readin.head())
    ...
    ### begin with starting col from metadata_readin
    starting_col = ['fasta_header', 'collection_date']
    biosample_df = metadata_readin[starting_col]
    
    col_rename = {'fasta_header' : 'sample_name'}
    ...
    biosample_df['collected_by'] = 'CDPHE'
